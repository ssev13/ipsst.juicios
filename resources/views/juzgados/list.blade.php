...
@section ('content')
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        {!! Form::open(['route' => ['juzgados.create'], 'method' => 'get']) !!}
                ...
                {!! Form::open(['route' => ['juzgados.list'], 'method' => 'get'])  !!}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <table>
                                                <tr>
                                                    <td>
                                                {!! Form::open(['route' => ['juzgados.show', $juzgado->id ], 'method' => 'get']) !!}
                                                ...
                                                {!! Form::open(['route' => ['juzgados.delete', $juzgado->id ], 'method' => 'delete', 'onsubmit' => 'return confirm("Está seguro de eliminar este juzgado?")']) !!}
            ...
            <!-- /.container-fluid -->
            {{ $juzgados->appends(Request::input())->links() }}
