    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('juicios.panel') }}"><img width="15%" src="{{ asset('img/logo1.gif') }}"></a>
            </div>
            <!-- Top Menu Items -->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="{{ route('abogados.list') }}"><i class="fa fa-fw fa-book"></i> Abogados Actor</a>
                    </li>
